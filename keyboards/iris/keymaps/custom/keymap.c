...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
                       LT(_NUMPAD, KC_ENT), KC_BSPC, TD(MOD_DANCE),       TD(MOD_DANCE), KC_SPC, KC_ENT
  //                  `----+----+----'        `----+----+----'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                          |--------+--------+--------+--------+--------+--------|
      _______, _______, KC_LCBR, KC_LBRC, KC_LPRN, KC_LT  ,                            KC_GT  , KC_RPRN, KC_RBRC, KC_LCBR, _______, _______,
  //|--------+--------+--------+--------+--------+--------|                          |--------+--------+--------+--------+--------+--------|
